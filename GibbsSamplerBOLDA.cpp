...
//  mexPrintf("\tNewest Version 12:55 pm\n");
  mexPrintf("\tStartcondition = %d\t", startcond);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~OPINION SAMPLING~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//if (((iter % 10 ) == 0)&&(OUTPUT==2)) mexPrintf("\tStarting Opinion Sampling; total steps are %d \n", n_O);
    if (NN - iter <25) {
	  for (ii = 0; ii<n_O; ii++)
	  {
...
/* allocate memory */
 ...
 for (i=0; i<n_O; i++) {
  ...
  if (OUTPUT==2) {
      mexPrintf( "Running BOLDA Gibbs Sampler Version 1.0\n" );
      if (startcond==1) mexPrintf( "Starting from previous state Z_W_IN\n" );
      mexPrintf( "Arguments:\n" );
      mexPrintf( "\tNumber of topic words      Voc_W = %d\n"    , Voc_W );
      mexPrintf( "\tNumber of opinion words 1  Voc_O1 = %d\n"    , Voc_O1 );
      mexPrintf( "\tNumber of opinion words 2  Voc_O2 = %d\n"    , Voc_O2 );
