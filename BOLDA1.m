...
function [ WP , DP , OP, Z_O, Z_W, phi_W, phi_O1, phi_O2, rho_1, rho_2, theta,mm, cost, iter1, iter5] = BOLDA1(x_w, d_w, x_o, d_o, l_o, l_w, alpha, beta_W, beta_O, gamma, T, EM_iters, pi, savefilename)
  %  pi = pi(2:end, 2:end);    
...
%+%   save('0iters.mat', 'mm','pi', 'Matching', 'c_new', 'M1_indices', 'M2_indices')
...
save('1iter.mat', 'mm','pi', 'c_new', 'M1_indices', 'M2_indices')
end
